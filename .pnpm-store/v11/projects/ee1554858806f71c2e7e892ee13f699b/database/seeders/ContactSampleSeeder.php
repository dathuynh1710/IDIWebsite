...
class ContactSampleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([
            ...
            ['Lê Thu Hà', 'ha.le@example.com', '0987654321', 'Tham quan nhà máy', 'Công ty chúng tôi mong muốn đăng ký lịch tham quan nhà máy và trao đổi cơ hội hợp tác.', 'vi', 'in_progress', 5],
            ...
            ['Sophia Wilson', 'sophia.wilson@example.com', '+44 20 7946 0182', 'Product sample follow-up', 'Thank you for the samples. Our quality team has completed the review and would like to discuss the next order.', 'en', 'in_progress', 8],
            ['王海', 'wang.hai@example.com', '+86 138 0013 8000', '巴沙鱼产品咨询', '我们希望了解冷冻巴沙鱼柳的规格、认证、最低订购量和交货时间。', 'zh', 'new', 0],
            ['李敏', 'li.min@example.com', '+86 139 0013 9000', '中国市场合作', '我们有兴趣在中国市场推广 IDI Seafood 产品，请提供合作政策和产品目录。', 'zh', 'in_progress', 12],
            ['Website Robot', 'robot-spam@example.net', null, 'SEO promotion service', 'Automated promotional message for an unrelated website optimization service.', 'en', 'in_progress', 3],
            ...
            $contact = ContactMessage::updateOrCreate(['email' => $email, 'subject' => $subject], [
                ...
                'locale' => $locale,
                'status' => $status,
                'assigned_to' => $status === 'in_progress' ? $adminId : null,
                'replied_at' => null,
            ]);
            $contact->forceFill([
