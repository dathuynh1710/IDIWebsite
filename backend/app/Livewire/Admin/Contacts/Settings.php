...
class Settings extends Component
{
    ...
    public function editLocation(int $locationId): void
    {
        ...
        $this->location_latitude = $location->latitude !== null ? (float) $location->latitude : null;
        $this->location_longitude = $location->longitude !== null ? (float) $location->longitude : null;
    ...
    public function saveLocation(): void
    {
        ...
        $validated = $this->validate([
            ...
            'location_map_embed' => ['nullable', 'string', 'max:10000'],
        ...
        if (filled($validated['location_map_embed'] ?? null) && $mapEmbed === null) {
            return;
        }
    ...
    {
        $this->reset([
            'editingLocationId', 'location_code', 'location_phone', 'location_email',
            'location_map_embed', 'location_latitude', 'location_longitude',
    ...
    private function sanitizeHtml(string $html): string
    {
        ...
        return trim(strip_tags($html, '<p><br><h2><h3><h4><strong><b><em><i><u><ul><ol><li><a><blockquote>'));
    }
