...
class Settings extends AdminComponent
{
    ...
    public function save(): void
    {
        ...
        $data = $this->validate([
            ...
            'description.vi'        => 'Nội dung giới thiệu (Tiếng Việt)',
            'description.en'        => 'Nội dung giới thiệu (English)',
            'description.zh'        => 'Nội dung giới thiệu (中文)',
            'benefits_content.vi'   => 'Phúc lợi (Tiếng Việt)',
            'benefits_content.en'   => 'Phúc lợi (English)',
            'benefits_content.zh'   => 'Phúc lợi (中文)',
            'contact_content.vi'    => 'Thông tin liên hệ (Tiếng Việt)',
            'contact_content.en'    => 'Thông tin liên hệ (English)',
            'contact_content.zh'    => 'Thông tin liên hệ (中文)',
            ...
            'application_enabled'   => 'Nhận đơn ứng tuyển',
            'hero_desktop'          => 'Ảnh hero (desktop)',
            'hero_mobile'           => 'Ảnh hero (mobile)',
            'gallery_uploads'       => 'Ảnh thư viện',
            'existing_gallery_images' => 'Ảnh thư viện hiện tại',
        ]);
