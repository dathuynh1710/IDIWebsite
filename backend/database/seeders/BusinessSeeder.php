...
class BusinessSeeder extends Seeder
{
    ...
    private function seedOfficeLocations(): void
    {
        foreach ([
            [
                'code' => 'HEAD_OFFICE',
                'name' => ['Trụ sở chính', 'Head office', '总部'],
                'address' => ['Quốc lộ 80, Cụm công nghiệp Vàm Cống, ấp An Thạnh, xã Lấp Vò, Tỉnh Đồng Tháp, Việt Nam', 'National Road 80, Vam Cong Industrial Cluster, An Thanh Hamlet, Lap Vo Commune, Dong Thap Province, Vietnam', '越南同塔省垃圩社安盛邑汪贡工业区80号国道'],
                'phone' => '+84 2773 680 383 · +84 2777 300 468',
                'fax' => '+84 2773 680 382',
                'email' => 'info@idiseafood.com',
                'map' => '<iframe src="https://www.google.com/maps?q=IDI+Seafood+Vam+Cong+Dong+Thap&amp;output=embed" loading="lazy" allowfullscreen></iframe>',
            ],
            [
                'code' => 'HCMC_OFFICE',
                'name' => ['Văn phòng đại diện Hồ Chí Minh', 'Ho Chi Minh City representative office', '胡志明市代表处'],
                'address' => ['9 Nguyễn Kim, phường 12, quận 5, Thành phố Hồ Chí Minh, Việt Nam', '9 Nguyen Kim Street, Ward 12, District 5, Ho Chi Minh City, Vietnam', '越南胡志明市第五郡第十二坊阮金街9号'],
                'phone' => '+84 932 824 888',
                'fax' => null,
                'email' => null,
                'map' => '<iframe src="https://www.google.com/maps?q=9+Nguyen+Kim+Ward+12+District+5+Ho+Chi+Minh+City&amp;output=embed" loading="lazy" allowfullscreen></iframe>',
            ],
        ] as $sortOrder => $office) {
