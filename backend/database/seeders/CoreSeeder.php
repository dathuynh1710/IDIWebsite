...
class CoreSeeder extends Seeder
{
    ...
    private function seedMedia(int $adminId): array
    {
        ...
        $definitions = [
            ...
            'document' => ['disk' => 'public_assets', 'folder' => 'documents', 'file' => 'annual-report-2025.pdf', 'mime' => 'application/pdf', 'title' => ['Báo cáo thường niên 2025', 'Annual report 2025', '2025 年年度报告']],
