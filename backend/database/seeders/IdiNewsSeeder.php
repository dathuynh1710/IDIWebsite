...
class IdiNewsSeeder extends Seeder
{
  ...
  private function seedMedia(int $adminId, string $code, string $title, string $fileName): int
  {
    $fileName = basename($fileName) ?: strtolower($code) . '.jpg';
...
HTML,
        'image' => 'SDAW25_LOGO_WIN_GBOTY_CAPAC.jpg',
        'featured' => true,
        'read_time' => 2,
        'view_count' => 3793,
        'tags' => ['idi', 'green'],
...
<p><img src="/assets/media/news/4z6079751883555_a57bc70602549e4b733727ea95391927.jpg" alt="Lễ công bố trái phiếu xanh I.D.I"></p>
...
<p><img src="/assets/media/news/7z6079816528177_fc866584d6c64b838bff000c86fea749.jpg" alt="Đại diện I.D.I tại sự kiện trái phiếu xanh"></p>
<p>Sau khi dự án hoàn thành, tổng công suất chế biến của I.D.I được kỳ vọng tiến gần mốc 600 tấn nguyên liệu/ngày.</p>
HTML,
        'image' => 'z6122228610437_a23bd95445e225017c694fcf4e5d247f.jpg',
        'featured' => true,
        'read_time' => 3,
        'view_count' => 4083,
