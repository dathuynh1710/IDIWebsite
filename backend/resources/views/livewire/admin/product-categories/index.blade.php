<div>
    <x-admin.page-header title="Danh mục sản phẩm" description="Sắp xếp và kiểm soát nhóm sản phẩm hiển thị trên website" :breadcrumbs="$breadcrumbs">
        <x-slot:actions>
            @can('products.create')
                <button class="button button-primary" type="button" wire:click="openCreateModal">
