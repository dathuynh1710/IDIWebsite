      ...
      <div className="relative z-10 flex-1 flex items-center">
        <div className="container py-24 sm:py-32">
          <div className="max-w-3xl">
            ...
            >
              {copy.titleBefore} <span className="text-coral-gold">{copy.titleAccent}</span> {copy.titleAfter}
            </h1>
        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4">
            {stats.map((stat, i) => (
              ...
              >
                <div className="text-2xl lg:text-3xl font-black text-coral-gold tracking-tight">{stat.value}</div>
